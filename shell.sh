...
docker run --net mynet --ip  172.23.0.2 -e MYSQL_ROOT_PASSWORD=password -e MYSQL_DATABASE=sakila -e MYSQL_USER=root -e  MYSQL_PASSWORD=password -p 3306:3306 --name data -d data
