...
public abstract class GeneratedStoreEntityStoreSerializerImpl implements EntityStoreSerializer<Store> {
    ...
    private static final int FIELD_STORE_ID = 0;
    private static final int FIELD_MANAGER_STAFF_ID = 2;
    private static final int FIELD_ADDRESS_ID = 4;
    private static final int FIELD_LAST_UPDATE = 8;
    private static final int FKREF_FK_STORE_ADDRESS = 16;
    private static final int FKREF_FK_STORE_STAFF = 24;
