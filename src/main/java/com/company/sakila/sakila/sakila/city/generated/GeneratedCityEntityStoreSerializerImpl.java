...
public abstract class GeneratedCityEntityStoreSerializerImpl implements EntityStoreSerializer<City> {
    ...
    private static final int FIELD_CITY_ID = 0;
    private static final int FIELD_COUNTRY_ID = 4;
    private static final int FIELD_LAST_UPDATE = 8;
    private static final int FKREF_FK_CITY_COUNTRY = 16;
    private static final int ENDPOS_CITY = 24;
