...
public abstract class GeneratedPaymentEntityStoreSerializerImpl implements EntityStoreSerializer<Payment> {
    ...
    private static final int FIELD_STAFF_ID = 0;
    private static final int FIELD_PAYMENT_ID = 2;
    private static final int FIELD_CUSTOMER_ID = 6;
    private static final int FIELD_PAYMENT_DATE = 10;
    private static final int FKREF_FK_PAYMENT_CUSTOMER = 18;
    private static final int FKREF_FK_PAYMENT_STAFF = 26;
    private static final int ENDPOS_RENTAL_ID = 34;
    private static final int FKREF_ENDPOS_FK_PAYMENT_RENTAL = 35;
    private static final int ENDPOS_LAST_UPDATE = 36;
    private static final int ENDPOS_AMOUNT = 37;
    private static final int VARSIZE_BEGINS = 41;
    ...
    public Class<?> deserializedType(final ColumnIdentifier<Payment> colId) {
        if (colId instanceof Payment.Identifier) {
            ...
            switch (_id) {
                ...
                case PAYMENT_DATE : return Timestamp.class;
    ...
    public LongPredicate isNull(final ColumnIdentifier<Payment> colId) {
        if (colId instanceof Payment.Identifier) {
            ...
            switch (_id) {
                ...
                case PAYMENT_ID   : 
                case CUSTOMER_ID  : 
                case PAYMENT_DATE : return ALWAYS_FALSE;
    ...
    public LongPredicate isPresent(final ColumnIdentifier<Payment> colId) {
        if (colId instanceof Payment.Identifier) {
            ...
            switch (_id) {
                ...
                case PAYMENT_ID   : 
                case CUSTOMER_ID  : 
                case PAYMENT_DATE : return ALWAYS_TRUE;
                case RENTAL_ID    : return ref -> bufferFinder.apply(ref).get(offsetFinder.applyAsInt(ref) + ENDPOS_RENTAL_ID) >= 0;
                case LAST_UPDATE  : return ref -> bufferFinder.apply(ref).get(offsetFinder.applyAsInt(ref) + ENDPOS_LAST_UPDATE) >= 0;
    ...
    public LongToIntFunction compareToNull(final ColumnIdentifier<Payment> colId) {
        if (colId instanceof Payment.Identifier) {
            ...
            switch (_id) {
                ...
                case PAYMENT_ID   : 
                case CUSTOMER_ID  : 
                case PAYMENT_DATE : return ALWAYS_LESS;
                case RENTAL_ID    : return ref -> {
                    final ByteBuffer buffer = bufferFinder.apply(ref);
                    final int offset = offsetFinder.applyAsInt(ref);
        ...
        if (colId instanceof Payment.Identifier) {
            ...
            switch (_id) {
                ...
                case LAST_UPDATE  : return ref -> {
                    ...
                    final int rowOffset = offsetFinder.applyAsInt(ref);
                    return predicate.test(buffer,
                        rowOffset + VARSIZE_BEGINS + (0x7f & buffer.get(rowOffset + ENDPOS_LAST_UPDATE - Byte.BYTES)),
        ...
        if (colId instanceof Payment.Identifier) {
            ...
            switch (_id) {
                ...
                case LAST_UPDATE  : return (aRef, bRef) -> {
                    ...
                    final int bRowOffset = offsetFinder.applyAsInt(bRef);
                    return comparator.compare(
                        aBuffer, aRowOffset + VARSIZE_BEGINS + (0x7f & aBuffer.get(aRowOffset + ENDPOS_LAST_UPDATE - Byte.BYTES)), aRowOffset + VARSIZE_BEGINS + aBuffer.get(aRowOffset + ENDPOS_LAST_UPDATE), 
                        bBuffer, bRowOffset + VARSIZE_BEGINS + (0x7f & bBuffer.get(bRowOffset + ENDPOS_LAST_UPDATE - Byte.BYTES)), bRowOffset + VARSIZE_BEGINS + bBuffer.get(bRowOffset + ENDPOS_LAST_UPDATE)
                    );
                };
                case AMOUNT       : return (aRef, bRef) -> {
                    final ByteBuffer aBuffer = bufferFinder.apply(aRef);
