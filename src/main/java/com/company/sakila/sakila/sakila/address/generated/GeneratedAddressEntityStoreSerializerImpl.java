...
public abstract class GeneratedAddressEntityStoreSerializerImpl implements EntityStoreSerializer<Address> {
    ...
    private static final int FIELD_ADDRESS_ID = 0;
    private static final int FIELD_CITY_ID = 4;
    private static final int FIELD_LAST_UPDATE = 8;
    private static final int FKREF_FK_ADDRESS_CITY = 16;
    private static final int ENDPOS_ADDRESS = 24;
    private static final int ENDPOS_ADDRESS2 = 28;
    private static final int ENDPOS_DISTRICT = 32;
    private static final int ENDPOS_POSTAL_CODE = 36;
    private static final int ENDPOS_PHONE = 40;
    private static final int ENDPOS_LOCATION = 44;
