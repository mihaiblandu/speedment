...
public abstract class GeneratedInventoryEntityStoreSerializerImpl implements EntityStoreSerializer<Inventory> {
    ...
    private static final int FIELD_INVENTORY_ID = 2;
    private static final int FIELD_FILM_ID = 6;
    private static final int FIELD_LAST_UPDATE = 10;
    private static final int FKREF_FK_INVENTORY_FILM = 18;
    private static final int FKREF_FK_INVENTORY_STORE = 26;
