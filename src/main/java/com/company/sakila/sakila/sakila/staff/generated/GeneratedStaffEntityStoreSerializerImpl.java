...
public abstract class GeneratedStaffEntityStoreSerializerImpl implements EntityStoreSerializer<Staff> {
    ...
    private static final int FIELD_STAFF_ID = 1;
    private static final int FIELD_STORE_ID = 3;
    private static final int FIELD_ADDRESS_ID = 5;
    private static final int FIELD_LAST_UPDATE = 9;
    private static final int FKREF_FK_STAFF_ADDRESS = 17;
    private static final int FKREF_FK_STAFF_STORE = 25;
    private static final int ENDPOS_FIRST_NAME = 33;
    private static final int ENDPOS_LAST_NAME = 37;
    private static final int ENDPOS_PICTURE = 41;
    private static final int ENDPOS_EMAIL = 45;
    private static final int ENDPOS_USERNAME = 49;
    private static final int ENDPOS_PASSWORD = 53;
    private static final int VARSIZE_BEGINS = 57;
